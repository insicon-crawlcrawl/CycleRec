...
# 데이터 로드
df_train = pd.read_csv("/workspace/T5/t5_train_pair_final_nn.csv")
df_val = pd.read_csv("/workspace/T5/t5_valid_pair_final_nn.csv")
...
model = T5ForConditionalGeneration.from_pretrained("t5-base").to("cuda:2")
...
for epoch in range(num_epochs):
    ...
    save_dir = f"/workspace/T5/t5base_pair_final_nn/epoch{epoch+1}"
...
output_path = "/workspace/T5/test_r20_predictions(t5base_pair_final_nn).csv"
